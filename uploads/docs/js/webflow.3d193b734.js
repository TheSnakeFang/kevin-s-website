  ...
  /******/ [
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      function merge(a, b, c, d, e, f) {
        for (
          var _len2 = arguments.length, rest = Array(_len2 > 6 ? _len2 - 6 : 0), _key2 = 6;
          _key2 < _len2;
          _key2++
        ) {
        ...
        return rest.length
          ? doMerge.call.apply(doMerge, [null, false, false, a, b, c, d, e, f].concat(rest))
      ...
      function mergeDeep(a, b, c, d, e, f) {
        for (
          var _len3 = arguments.length, rest = Array(_len3 > 6 ? _len3 - 6 : 0), _key3 = 6;
          _key3 < _len3;
          _key3++
        ) {
        ...
        return rest.length
          ? doMerge.call.apply(doMerge, [null, false, true, a, b, c, d, e, f].concat(rest))
      ...
      function mergeIn(a, path, b, c, d, e, f) {
        ...
        for (
          var _len4 = arguments.length, rest = Array(_len4 > 7 ? _len4 - 7 : 0), _key4 = 7;
          _key4 < _len4;
          _key4++
        ) {
      ...
      function addDefaults(a, b, c, d, e, f) {
        for (
          var _len5 = arguments.length, rest = Array(_len5 > 6 ? _len5 - 6 : 0), _key5 = 6;
          _key5 < _len5;
          _key5++
        ) {
        ...
        return rest.length
          ? doMerge.call.apply(doMerge, [null, true, false, a, b, c, d, e, f].concat(rest))
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      function createStore(reducer, preloadedState, enhancer) {
        ...
        return (
          ...
          (_ref2[symbol_observable__WEBPACK_IMPORTED_MODULE_1__['default']] = observable),
          _ref2
        );
      }
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      window.tram = (function (a) {
          ...
          m = {
            ease: [
              ...
              function (a, b, c, d) {
                var e = (a /= d) * a,
                  f = e * a;
                return b + c * (-2.75 * f * e + 11 * e * e + -15.5 * f + 8 * e + 0.25 * a);
              },
            ],
            'ease-in': [
              'ease-in',
            ...
            'ease-out': [
              ...
              function (a, b, c, d) {
                var e = (a /= d) * a,
                  f = e * a;
                return b + c * (0.3 * f * e + -1.6 * e * e + 2.2 * f + -1.8 * e + 1.9 * a);
              },
            ],
            'ease-in-out': [
              'ease-in-out',
          ...
          L = l(function (b) {
            ...
            function e(a, b, c) {
              if (a) {
                ...
                if (
                  (b || (this.timer && this.timer.destroy(), (this.queue = []), (this.active = !1)),
                  'number' == e && b)
                )
                  return (
                    (this.timer = new S({
            ...
            function l(a) {
              ...
              'string' == typeof a
                ? ((b = {}), (b[a] = 1))
                : (b = 'object' == (0, _typeof2['default'])(a) && null != a ? a : this.props),
                u.call(this, b, v),
                t.call(this);
            }
            ...
            function t() {
              ...
              (c = c.join(',')),
                this.style !== c && ((this.style = c), (this.el.style[G.transition.dom] = c));
            }
            ...
            (a.init = function (a, b, d, e) {
              ...
              (a.stop = function () {
                (this.active || this.nextStyle) &&
                  ((this.active = !1), (this.nextStyle = null), V(this.el, this.name, this.get()));
                var a = this.tween;
          ...
          T = l(R, function (a, b) {
            (a.init = function (a) {
              ...
              (a.render = function (a) {
                ...
                for (b = d; b--; ) {
                  (c = this.tweens[b]),
                    c.context && (c.render(a), (this.current[c.name] = c.value), (e = !0));
                }
        ...
        G.transform &&
          ...
          G.transform &&
            G.backface &&
            ((Z.z = [w, 'translateZ']), (Z.rotateZ = [x]), (Z.scaleZ = [t]), (Z.perspective = [v]));
        var $ = /ms/,
          _ = /s|\./;
        return (a.tram = b);
      })(window.jQuery);
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      function inOutElastic(pos) {
        ...
        if (pos < 1) {
          return (
            -0.5 * (a * Math.pow(2, 10 * (pos -= 1)) * Math.sin(((pos - s) * (2 * Math.PI)) / p))
          );
        }

        return (
          a * Math.pow(2, -10 * (pos -= 1)) * Math.sin(((pos - s) * (2 * Math.PI)) / p) * 0.5 + 1
        );
      }
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      function applyEasing(easing, position, customEasingFn) {
        ...
        return optimizeFloat(
          position > 0 && easing && easings[easing] ? easings[easing](position) : position
        );
      }
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      function handlePlaybackRequest(playback, store) {
        ...
        if (
          (actionListId && actionTypeId === _constants.ActionTypeConsts.GENERAL_START_ACTION) ||
      ...
      function bindEventType(_ref13) {
        ...
        (0, _forEach['default'])(eventTargets, function (elements, key) {
          ...
          var eventAction = event.action,
            ...
            mediaQueries =
              _event$mediaQueries === void 0 ? ixData.mediaQueryKeys : _event$mediaQueries;
          ...
          if (
            eventAction.actionTypeId === _constants.ActionTypeConsts.GENERAL_START_ACTION ||
        ...
        var handleEvent = function handleEvent(nativeEvent) {
          ...
          forEachEventTarget(eventTargets, function (element, eventId, eventStateKey) {
            ...
            var eventAction = event.action,
              ...
              mediaQueries =
                _event$mediaQueries2 === void 0 ? ixData.mediaQueryKeys : _event$mediaQueries2; // Bypass event handler if current media query is not listed in event config
            ...
            if (
              eventAction.actionTypeId === _constants.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION
            ) {
              var configs = Array.isArray(event.config) ? event.config : [event.config];
        ...
        var addListeners = function addListeners(_ref15) {
          ...
          types
            ...
            .forEach(function (type) {
              ...
              store.dispatch(
                (0, _IX2EngineActions.eventListenerAdded)(target, [type, handlerFunc])
              );
            });
        };
      ...
      function injectBehaviorCSSFixes(events) {
        ...
        for (var eventId in events) {
          ...
          if (
            ...
            cssText += selector + '{' + 'cursor: pointer;' + 'touch-action: manipulation;' + '}'; // $FlowFixMe
          }
        }
      ...
      function startActionGroup(_ref19) {
        ...
        var _event$mediaQueries3 = event.mediaQueries,
          mediaQueries =
            _event$mediaQueries3 === void 0 ? ixData.mediaQueryKeys : _event$mediaQueries3;
      ...
      function renderImmediateInstance(store, instanceId) {
        ...
        store.dispatch(
          (0, _IX2EngineActions.animationFrameChanged)(performance.now(), ixParameters)
        );
      ...
      function handleInstanceChange(instance, store) {
        ...
        var _event$mediaQueries4 = event.mediaQueries,
          mediaQueries =
            _event$mediaQueries4 === void 0 ? ixData.mediaQueryKeys : _event$mediaQueries4;
      ...
      Webflow.define(
        ...
        (module.exports = function ($, _, options) {
          ...
          try {
            ...
            hasLocalStorage =
              localStorage && localStorage.getItem && localStorage.getItem('WebflowEditor');
          } catch (e) {
...
*/
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var ixData = function ixData() {
        var state =
          arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : Object.freeze({});
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var stateKeys = Object.create(
        null,
        ((_Object$create = {}),
        (0, _defineProperty2['default'])(_Object$create, IX2_PREVIEW_REQUESTED, {
          value: 'preview',
        }),
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var colorStyleProps = Object.freeze(
        ((_Object$freeze = {}),
        (0, _defineProperty2['default'])(_Object$freeze, STYLE_BACKGROUND_COLOR, BACKGROUND_COLOR),
        (0, _defineProperty2['default'])(_Object$freeze, STYLE_BORDER, BORDER_COLOR),
        (0, _defineProperty2['default'])(_Object$freeze, STYLE_TEXT_COLOR, COLOR),
        _Object$freeze)
      );
      var willChangeProps = Object.freeze(
        ...
        (0, _defineProperty2['default'])(_Object$freeze2, BACKGROUND_COLOR, BACKGROUND),
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var actionGroupCreator = function actionGroupCreator(_ref4, state) {
        ...
        if (eventToStop) {
          (0, _IX2VanillaEngine.stopActionGroup)({
            ...
            eventTarget: element,
            eventStateKey:
              autoStopEventId + COLON_DELIMITER + eventStateKey.split(COLON_DELIMITER)[1],
      ...
      var whenElementHoverChange = function whenElementHoverChange(handler) {
        return function (options, oldState) {
          ...
          if (
            oldState ? newState.elementHovered !== oldState.elementHovered : newState.elementHovered
          ) {
            return handler(options, newState) || newState;
          }
      ...
      var whenElementVisibiltyChange = function whenElementVisibiltyChange(handler) {
        return function (options, oldState) {
          ...
          if (
            oldState ? newState.elementVisible !== oldState.elementVisible : newState.elementVisible
          ) {
            return handler(options, newState) || newState;
          }
      ...
      var whenScrollDirectionChange = function whenScrollDirectionChange(handler) {
        return function (options) {
          ...
          var scrollTopPadding =
            (isPX ? scrollOffsetValue : (innerHeight * (scrollOffsetValue || 0)) / 100) /
            scrollHeightBounds;
          var scrollingDown;
      ...
      var _default =
        ((_default2 = {}),
        (0, _defineProperty2['default'])(_default2, SLIDER_ACTIVE, getComponentActiveOptions()),
        (0, _defineProperty2['default'])(_default2, SLIDER_INACTIVE, getComponentInactiveOptions()),
        (0, _defineProperty2['default'])(_default2, DROPDOWN_OPEN, getComponentActiveOptions()),
        (0, _defineProperty2['default'])(_default2, DROPDOWN_CLOSE, getComponentInactiveOptions()),
        (0, _defineProperty2['default'])(_default2, NAVBAR_OPEN, getComponentActiveOptions(false)),
        (0, _defineProperty2['default'])(
          _default2,
          NAVBAR_CLOSE,
          getComponentInactiveOptions(false)
        ),
        (0, _defineProperty2['default'])(_default2, TAB_ACTIVE, getComponentActiveOptions()),
        ...
        (0, _defineProperty2['default'])(_default2, MOUSE_MOVE, {
          ...
          handler: function handler(_ref8) {
            ...
            if (
              isMouseOut &&
              (value > 1 - MOUSE_OUT_ROUND_THRESHOLD || value < MOUSE_OUT_ROUND_THRESHOLD)
            ) {
        ...
        (0, _defineProperty2['default'])(_default2, PAGE_SCROLL, {
          ...
          handler: function handler(_ref9) {
            ...
            value = reverse ? 1 - value : value;
            store.dispatch(
              (0, _IX2EngineActions.parameterChanged)(continuousParameterGroupId, value)
            );
          },
        }),
          ...
          handler: function handler(_ref10) {
            ...
            if (basedOn === _constants.EventBasedOn.VIEWPORT) {
              ...
              var offsetElementTop =
                elementRect.top + Math.min(elementRect.height * offsetStartPerc, visibleHeight);
              ...
              if (fixedScrollPerc !== state.scrollPercent) {
                store.dispatch(
                  (0, _IX2EngineActions.parameterChanged)(namespacedParameterId, fixedScrollPerc)
                );
              }
        ...
        (0, _defineProperty2['default'])(_default2, SCROLL_INTO_VIEW, scrollIntoOutOfViewOptions),
        (0, _defineProperty2['default'])(_default2, SCROLL_OUT_OF_VIEW, scrollIntoOutOfViewOptions),
        (0, _defineProperty2['default'])(
          _default2,
          PAGE_SCROLL_DOWN,
      ...
      Webflow.define(
        ...
        (module.exports = function ($, _) {
          ...
          function select(link) {
            var href =
              (designer && link.getAttribute('href-disabled')) || link.getAttribute('href');
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      Webflow.define(
        ...
        (module.exports = function ($) {
          ...
          var headerSelector =
            'header, ' + rootTag + ' > .header, ' + rootTag + ' > .w-nav:not([data-no-scroll])';
          ...
          function linksToCurrentPage(link) {
            return (
              validHash.test(link.hash) && link.host + link.pathname === loc.host + loc.pathname
            );
          }
          /**
      ...
      Webflow.define(
        ...
        (module.exports = function ($, _) {
          ...
          function addListeners() {
            ...
            $doc.on(
              'change',
              namespace + ' form input[type="checkbox"]:not(' + CHECKBOX_CLASS_NAME + ')',
              function (evt) {
            ...
            $doc.on('change', namespace + ' form input[type="radio"]', function (evt) {
              $(
                'input[name="'.concat(evt.target.name, '"]:not(').concat(CHECKBOX_CLASS_NAME, ')')
              ).map(function (i, el) {
...
Webflow.require('ix2').init({
  events: {
    e: {
      ...
      target: {
        id: '6119ef28f83bf70c6d1d4154|eaa64509-298b-b257-89c9-432ccb91dee1',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-3': {
      ...
      target: {
        ...
        originalId: '6119ef28f83bf70c6d1d4154|2d79a236-b72b-a903-df9b-9e6995cbe657',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-5': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: { id: '6119ef28f83bf70c6d1d4154', appliesTo: 'PAGE', styleBlockIds: [] },
      targets: [{ id: '6119ef28f83bf70c6d1d4154', appliesTo: 'PAGE', styleBlockIds: [] }],
      config: [
        {
    ...
    'e-6': {
      ...
      mediaQueries: ['main', 'medium'],
      target: {
        id: '6119ef28f83bf70c6d1d4154|a5b07f57-1d98-2bba-387d-17a3692649b0',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-8': {
      ...
      target: {
        ...
        originalId: '6119ef28f83bf70c6d1d4154|a0c303eb-04dc-4f9a-f870-141b4b14d70d',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-11': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: { id: '6119ef28f83bf780f91d4158', appliesTo: 'PAGE', styleBlockIds: [] },
      targets: [{ id: '6119ef28f83bf780f91d4158', appliesTo: 'PAGE', styleBlockIds: [] }],
      config: {
        loop: false,
        playInReverse: false,
        scrollOffsetValue: null,
    ...
    'e-13': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '7e4ffaa6-4004-24bb-2c60-b77287bf5ee3',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
        { id: '7e4ffaa6-4004-24bb-2c60-b77287bf5ee3', appliesTo: 'ELEMENT', styleBlockIds: [] },
      ],
      config: {
        loop: false,
        playInReverse: false,
    ...
    'e-20': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '6119ef28f83bf780f91d4158|3ac9c012-ea70-37ed-df89-d815e73d84b3',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-21': {
      ...
      mediaQueries: ['main', 'medium'],
      target: {
        id: '6119ef28f83bf780f91d4158|7322ec6e-4497-8d0a-a030-4e1f72696d61',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-23': {
      ...
      target: {
        ...
        originalId: '6119ef28f83bf780f91d4158|16ba63d1-8fd3-c77d-501a-0c521d7b24ff',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-28': {
      ...
      target: {
        ...
        originalId: '6119ef28f83bf70c6d1d4154|c9c863c5-b0e6-2293-2e15-f76aeaecb28e',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-29': {
      ...
      target: {
        ...
        originalId: 'ec53809d-efe6-038c-5e9f-e4ae35351921',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-31': {
      ...
      target: {
        selector: '.clone-button',
        originalId: '6119ef28f83bf70c6d1d4154|4f60088d-246b-85c0-3a82-a314ee7f2c65',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-33': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: { id: '6119ef4640e8f9ddd9ddb9f4', appliesTo: 'PAGE', styleBlockIds: [] },
      targets: [{ id: '6119ef4640e8f9ddd9ddb9f4', appliesTo: 'PAGE', styleBlockIds: [] }],
      config: [
        {
    ...
    'e-36': {
      ...
      target: {
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
        id: '6119ef28f83bf70c6d1d4154|b1237fda-1dbd-6535-d934-8cf2d87577ce',
      },
      targets: [],
      config: {
        loop: false,
    ...
    'e-39': {
      ...
      createdOn: 1629170626935,
    },
  },
  actionLists: {
    a: {
      id: 'a',
      title: 'Content Scroll / Desktop',
      continuousParameterGroups: [
        {
          id: 'a-p',
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selector: '.heading',
                      selectorGuids: ['760a8f45-979f-2954-f29f-a060b4385474'],
                    },
                    xValue: -8,
                    yValue: -5,
                    xUnit: 'vw',
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: ['9fe14705-ec56-cec8-2427-5faf003ea7d8'],
                    },
                    xValue: 100,
                    xUnit: 'vw',
                    yUnit: 'PX',
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.project-content-details',
                      selectorGuids: ['c1330bec-a5e4-bbb7-14b1-716fa6c26cbc'],
                    },
                    xValue: -20,
                    xUnit: '%',
                    yUnit: 'PX',
    ...
    'a-2': {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: 'CHILDREN',
                  selector: '.image',
                  selectorGuids: ['e2d37a96-c230-3e1a-580c-8eec9776b1f3'],
                },
                xValue: -50,
                yValue: -50,
                xUnit: '%',
      ...
      createdOn: 1626818962404,
    },
    'a-3': {
      id: 'a-3',
      title: 'Project Mouseleave',
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    'a-4': {
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    duration: 500,
                    target: {
                      selector: '.mouse-cursor-container',
                      selectorGuids: ['75434dd0-2141-66be-cd4f-1def98fdbd8a'],
                    },
                    xValue: -50,
                    xUnit: 'vw',
                    yUnit: 'PX',
      ...
      createdOn: 1626819422292,
    },
    'a-7': {
      id: 'a-7',
      title: 'Project Click/ Desktop',
      actionItemGroups: [
        {
          actionItems: [
            {
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ['a89976f7-1489-a8a9-fd77-6c081424f127'],
                },
                value: 0,
                unit: '',
              },
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    '760a8f45-979f-2954-f29f-a060b4385474',
                    '227e1fa3-8faa-beaa-5412-b1db760e3545',
                  ],
                },
                value: 0,
                unit: '',
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  selector: '.cursor-icon',
                  selectorGuids: ['83dc69ed-b4e1-10f0-558d-c63fa4bb0d68'],
                },
                zValue: 45,
                xUnit: 'deg',
                yUnit: 'DEG',
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ['0dfa2ac4-4ce8-2deb-cf88-ab68595004cb'],
                },
                widthValue: 80,
                heightValue: 80,
                widthUnit: 'px',
    ...
    'a-6': {
      ...
      useFirstGroupAsInitialState: false,
      createdOn: 1626819522284,
    },
    'a-14': {
      id: 'a-14',
      title: 'Project Load V2',
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  selector: '.project-hero-headline.outline',
                  selectorGuids: [
                    'd31143a3-2f56-0819-b5b7-8b56f30c8911',
                    '633b09b1-89d3-a126-deee-622d0da852a1',
                  ],
                },
                xValue: 0.7,
                yValue: 0.7,
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1627499755629,
    },
    'a-9': {
      id: 'a-9',
      title: 'Logo Mouseover',
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: 'CHILDREN',
                  selector: '.logo-half-bottom',
                  selectorGuids: ['230471f9-4d48-aa17-06ac-3c852e6cd828'],
                },
                xValue: 0,
                yValue: 100,
                xUnit: 'px',
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: 'CHILDREN',
                  selector: '.logo-half-top',
                  selectorGuids: ['1cd71de4-1866-51cb-3164-9635e6225680'],
                },
                xValue: 0,
                xUnit: 'px',
                yUnit: 'PX',
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1626993291466,
    },
    'a-10': {
      id: 'a-10',
      title: 'Logo Mouseleave',
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    'a-11': {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                easing: '',
                duration: 500,
                target: { id: '514e8944-c5c4-3783-f6b4-1bc311be2fb1' },
                value: 0,
                unit: '',
              },
            },
            {
              ...
              config: {
                ...
                easing: '',
                duration: 500,
                target: { id: '514e8944-c5c4-3783-f6b4-1bc311be2fb5' },
                xValue: 100,
                yValue: 95,
                xUnit: '%',
                yUnit: '%',
            ...
            },
            {
              ...
              config: {
                ...
                easing: '',
                duration: 500,
                target: { id: '514e8944-c5c4-3783-f6b4-1bc311be2fb2' },
                xValue: -100,
                xUnit: '%',
                yUnit: 'PX',
                zUnit: 'PX',
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                easing: 'outQuint',
                duration: 500,
                target: { id: '514e8944-c5c4-3783-f6b4-1bc311be2fb0' },
                value: 0,
                unit: '',
              },
            },
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1627305919788,
    },
    'a-12': {
      id: 'a-12',
      title: 'Project Click/ Mobile',
      actionItemGroups: [
        {
          actionItems: [
            {
          ...
          actionItems: [
            ...
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  selector: '.project-paragraph',
                  selectorGuids: ['8a9af813-aeed-8bcb-59f8-9fced97773ac'],
                },
                value: 0,
                unit: '',
              },
    ...
    'a-15': {
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.hero-headline-container',
                      selectorGuids: ['7fd58653-2505-297e-1918-b1b3c2a574d8'],
                    },
                    yValue: 0,
                    xUnit: '%',
                    yUnit: 'vw',
      ...
      createdOn: 1627500775486,
    },
    'a-17': {
      id: 'a-17',
      title: 'Next Project Image Float',
      continuousParameterGroups: [
        {
          id: 'a-17-p',
          type: 'MOUSE_X',
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.next-project-image',
                      selectorGuids: ['b6b8789f-b07e-acf2-ccd5-20b5222ada1b'],
                    },
                    xValue: -80,
                    xUnit: '%',
                    yUnit: 'PX',
      ...
      createdOn: 1627506162254,
    },
    'a-18': {
      id: 'a-18',
      title: 'Next Project Image Reveal',
      actionItemGroups: [
        {
          actionItems: [
            {
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1627506250374,
    },
    'a-19': {
      id: 'a-19',
      title: 'Next Project Image Hide',
      actionItemGroups: [
        {
          actionItems: [
            {
          ...
          actionItems: [
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: 'CHILDREN',
                  selector: '.arrow',
                  selectorGuids: ['57a5da6c-6e09-6d62-1480-4f1741cb6669'],
                },
                value: 0,
                unit: '',
              },
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: 'CHILDREN',
                  selector: '.next-project-label',
                  selectorGuids: ['02cf6682-68e7-ee37-49b1-5c1adbf11053'],
                },
                value: 0,
                unit: '',
              },
    ...
    'a-21': {
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.container',
                      selectorGuids: ['8a149d97-01eb-698b-2dc7-17aa531b7101'],
                    },
                    value: 0,
                    unit: '',
                  },
      ...
      createdOn: 1627507878254,
    },
    'a-22': {
      id: 'a-22',
      title: 'Clone Mouseover',
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: 'CHILDREN',
                  selector: '.clone-button-arrow',
                  selectorGuids: ['381cd080-6f69-fac2-b5f5-1df9671c5e5f'],
                },
                xValue: 0,
                xUnit: 'em',
                yUnit: 'PX',
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1627598514874,
    },
    'a-23': {
      id: 'a-23',
      title: 'Clone Mouseleave',
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    duration: 500,
                    target: {
                      selector: '.stair-heading',
                      selectorGuids: ['ec40be40-2aaa-2a88-ad24-09741bc1a368'],
                    },
                    yValue: 0,
                    xUnit: 'PX',
                    yUnit: '%',
